...
namespace GoBot.Calculs.Formes
{
    public interface IForme
    {
        ...
        /// <summary>
        /// Retourne la liste des PointReel de croisement entre la Forme courante et la Forme donnée
        /// </summary>
        /// <param name="?">Forme testée</param>
        /// <returns>Liste des PointReel de croisement</returns>
