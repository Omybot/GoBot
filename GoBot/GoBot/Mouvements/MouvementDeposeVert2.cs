...
{
    class MouvementDeposeVert2 : Mouvement
    {
        private bool ramasse;

        public MouvementDeposeVert2()
        {
            ramasse = false;
            Positions.Add(new Position(90, new PointReel(3000 - 500, 700)));
        }
        ...
        {
            get { return Plateau.Elements.ZoneDeposeVert2; }
        }
