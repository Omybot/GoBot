...
namespace GoBot.Beacons
{
    ...
    {
        /// <summary>
        /// Détections effectuées par le capteur  de la balise
        /// </summary>
        public List<BeaconDetection> DetectionsCapteur1 { get; set; }

        /// <summary>
        /// Détections effectuées par le capteur 2 de la balise
        /// </summary>
        public List<BeaconDetection> DetectionsCapteur2 { get; set; }

        /// <summary>
        /// Détections effectuées par les capteurs en prenant en compte les deux capteurs
        /// </summary>
        public List<BeaconDetection> Detections { get; set; }

        public List<BeaconDetection> DetectionsRapides { get; set; }
        ...
        /// </summary>
        public BeaconStats Stats { get; private set; }
            ...
            try
            {
                if (trame[1] == (byte)UdpFrameFunction.DetectionBaliseRapide)
                {
                    if (Position != null)
                    {
                        ...
                        if (DetectionsRapides == null)
                            DetectionsRapides = new List<BeaconDetection>();
                ...
                if (trame[1] == (byte)UdpFrameFunction.DetectionBalise)
                {
                    if (Position != null)
                    {
                        ...
                        Detections = new List<BeaconDetection>();
                        ...
                        if (!ReglageOffset && Plateau.ReflecteursNosRobots)
                        {
                            foreach (Robot robot in Robots.DicRobots.Values)
                            {
                                ...
                                {
                                    BeaconDetection detection = Detections[i];
        ...
        public BeaconDetection MoyennerMesures(int nbMesures)
        {
            // TODO
            return null;
        }
