...
namespace GoBot.Devices
{
    public static class PololuMiniUart
    {
        public static void setTarget(byte channel, ushort target)
        {
            ...
            Connections.ConnectionIO.SendMessage(TrameFactory.EnvoyerUart(Carte.RecIO, new Trame(serialBytes)));
        }
        ...
        public static void setSpeed(byte channel, ushort target)
        {
            ...
            Connections.ConnectionMove.SendMessage(TrameFactory.EnvoyerUart(Carte.RecMove, new Trame(serialBytes)));
        }
